...
%>
<c:set var="myBidList" value="<%= auctionArticleDao.getMyBidList(user_id) %>"/>
<!DOCTYPE html>
<html>
<head>
				...
				<tr class="auctionList">
					...
					<td style="text-align:center;">
						...
						<c:if test="${result.boolean_isBid == true}">
							<button class="button red big" type="button" onClick="location.href = './insertBuyForm.jsp?article_id=${result.article_id}';">구매하기</button>
						</c:if>
					</td>					
				</tr>
				</c:forEach>
